...
public class A_Lambdas {
    ...
    public void g_boundMethodRef1() {
        final String literal = "abcdefghij";
        Function<String, Integer> func = literal::indexOf;
    ...
    public void g_boundMethodRef2() {
        final String myObject = "abcdefghij";
        Function<String, Integer> func = myObject::indexOf;
